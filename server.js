...
app.get('/team_stats', function(req, res) {
  var query1 = "SELECT * FROM football_games WHERE game_date < '20190101';";
  var query2 = "SELECT COUNT(*) FROM football_games WHERE game_date < '20190101' AND home_score > visitor_score;";
  var query3 = "SELECT COUNT(*) FROM football_games WHERE game_date < '20190101' AND home_score < visitor_score;";
  db.task('get-everything', task => {
    return task.batch([
      task.any(query1),
      task.any(query2),
...
app.get('/player_info/select_player',function(req,res){
  ...
  var query3 = 'SELECT count(*) FROM football_games INNER JOIN football_players ON football_players.id = any(football_games.players) AND football_players.id = ' + player_id + ';';
  db.task('get-everything', task =>{
    return task.batch([
      task.any(query1),
      task.any(query2),
